export const testIcon = [
  { id: '1bcddudhmh', name: '车贷',icon:'chedai'},
  { id: 'hc5g66kviq', name: '车辆保养',icon:'baoyang'},
  { id: '8s0p77c323',  name: '房贷' ,icon:'fangdai'},
  { id: '0fnhbcle6hg', name: '房屋租赁',icon:'fangzu' },
  { id: 'odrjk823mj8', name: '家庭用品' ,icon:'jiayong'},
  { id: 'bsn20th0k2o', name: '交通' ,icon:'jiaotong'},
  { id: 'j1h1nohhmmo', name: '旅游' ,icon:'lvyou'},
  { id: '3tqndrjqgrg', name: '日常饮食' ,icon:'yinshi'},
  { id: 's73ijpispio', name: '工资' ,icon:'gongzi'},
  { id: '1vjj47vpd28', name: '股票投资',icon:'gupiao'},
  { id: '5il79e11628', name: '基金投资' ,icon:'jijin'}
]
